...
class FosRestConfig implements \Symfony\Component\Config\Builder\ConfigBuilderInterface
{
     ...
     */
    public function paramFetcherListener(mixed $value = []): \Symfony\Config\FosRest\ParamFetcherListenerConfig|static
    {
        if (!\is_array($value)) {
     ...
     */
    public function allowedMethodsListener(mixed $value = []): \Symfony\Config\FosRest\AllowedMethodsListenerConfig|static
    {
        if (!\is_array($value)) {
     ...
     */
    public function bodyConverter(mixed $value = []): \Symfony\Config\FosRest\BodyConverterConfig|static
    {
        if (!\is_array($value)) {
     ...
     */
    public function exception(mixed $value = []): \Symfony\Config\FosRest\ExceptionConfig|static
    {
        if (!\is_array($value)) {
     ...
     */
    public function bodyListener(mixed $value = []): \Symfony\Config\FosRest\BodyListenerConfig|static
    {
        if (!\is_array($value)) {
     ...
     */
    public function versioning(mixed $value = []): \Symfony\Config\FosRest\VersioningConfig|static
    {
        if (!\is_array($value)) {
