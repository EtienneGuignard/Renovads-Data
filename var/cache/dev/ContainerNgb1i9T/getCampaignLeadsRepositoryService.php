 ...
 */
class getCampaignLeadsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CampaignLeadsRepository' shared autowired service.
     *
     * @return \App\Repository\CampaignLeadsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CampaignLeadsRepository.php';

        return $container->privates['App\\Repository\\CampaignLeadsRepository'] = new \App\Repository\CampaignLeadsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
