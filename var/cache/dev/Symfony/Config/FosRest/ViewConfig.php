...
class ViewConfig 
{
     ...
     */
    public function mimeTypes(mixed $value = []): \Symfony\Config\FosRest\View\MimeTypesConfig|static
    {
        if (!\is_array($value)) {
     ...
     */
    public function viewResponseListener(mixed $value = []): \Symfony\Config\FosRest\View\ViewResponseListenerConfig|static
    {
        if (!\is_array($value)) {
