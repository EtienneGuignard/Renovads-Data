 ...
 */
class getRuleGroupRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RuleGroupRepository' shared autowired service.
     *
     * @return \App\Repository\RuleGroupRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RuleGroupRepository.php';

        return $container->privates['App\\Repository\\RuleGroupRepository'] = new \App\Repository\RuleGroupRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
